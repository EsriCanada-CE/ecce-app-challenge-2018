...
Canvas {
    ...
    property alias textMode: sketchPalette.textMode
    property alias lineMode: sketchPalette.lineMode
    property alias arrowMode: sketchPalette.arrowMode
    ...
    property alias textInputColor: textInput.textColor
    ...
    function addTextSketch(x, y, text, color, angle, alignment, baseline, font, maximumWidth) {
