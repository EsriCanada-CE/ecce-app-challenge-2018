    ...
    ColumnLayout {
                        ...
                        ColumnLayout{
                            ...
                            Rectangle{
                                ...
                                TextField{
                                    ...
                                    text: fileInfo.fileName                                    
                                    verticalAlignment: Text.AlignVCenter
                                    font.pixelSize: height*0.8 //app.subtitleFontSize
                                    textColor: renameField.focus? "#1c1c1c":"white"
                                    style: TextFieldStyle{
                                        background: Rectangle{
                                            anchors.fill: parent
                                            color: renameField.focus? "white":"#282828"
                                        }
        ...
        Rectangle {
            ...
            Icon{
                ...
                visible: AppFramework.fileInfo(previewImageRect.source).suffix.toLowerCase() !== "gif"
                onIconClicked: {
